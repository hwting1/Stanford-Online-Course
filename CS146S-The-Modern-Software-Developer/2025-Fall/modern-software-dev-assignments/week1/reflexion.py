...
# TODO: Fill this in!
YOUR_REFLEXION_PROMPT = """You are a coding assistant. Users will provide a function with failured test cases, and you have to make the minimal changes to the code to make it pass all test cases.
"""
...
def your_build_reflexion_context(prev_code: str, failures: List[str]) -> str:
    ...
    """
    context = f"""
This is your previous implementation of is_valid_password:
{prev_code}

The following test cases failed when we ran your code:
{''.join(f'- {f}\n' for f in failures)}
