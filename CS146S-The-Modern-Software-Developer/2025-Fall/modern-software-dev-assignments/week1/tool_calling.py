...
# TODO: Fill this in!
YOUR_SYSTEM_PROMPT = f"""You are a helpful assitant that can call tools to meet the user's request. If you want to call a tool, you should output following format without any additional text:
{{
    "tool": "<tool_name>",
    "args": {{
        "<arg_name>": <arg_value>,
...
The following are tools that you can call:
{TOOL_REGISTRY}
"""
